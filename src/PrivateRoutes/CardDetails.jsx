    ...
    return (
        <div className='w-11/12 mx-auto'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mx-auto">
                {/* Left side */}
                <div className="col-span-2 space-y-4 max-w-4xl mx-auto  rounded-lg shadow-md border border-gray-200 bg-sky-100 p-6">
                    {/* Main Content */}
                    <div>
                        {/* Left Section: Image */}
                        <div className="">
                        ...
                        <div className="space-y-2">
                            <div className="flex mt-4 items-center  space-x-2">
                                <span className="px-4 py-2 text-sm font-medium bg-sky-200 text-blue-600 capitalize rounded-full">
                                    {type}
                                </span>
                            </div>
                            <h2 className="text-3xl text-blue-800 capitalize font-bold ">{title}</h2>
                            <p className="font-semibold text-blue-800 opacity-70">{description}</p>
                            <p className="text-[18px] w-64 rounded-full bg-sky-200 text-blue-600 px-4 py-2 ">
                                {/* focus  */}
                ...
                {/* right sides */}
                <div className='col-span-1 space-y-10 mx-auto'>
                    <div className="col-span-1 lg:col-span-1 text-center bg-sky-100 rounded-lg  p-4">
                        <div className=''>
                            <h1 className='bg-sky-200 text-blue-900 mb-2 w-fit mx-auto p-2 rounded-lg'>Organizer</h1>
                        </div>
                    ...
                    <div className="max-w-sm mx-auto bg-sky-100 rounded-lg shadow-md border border-gray-200 p-6 text-center">
                        {/* Donation Amount */}
